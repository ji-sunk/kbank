  ...
  return (
    <div className={`sheet ${open ? "open" : ""}`} role="dialog" aria-modal>
      <div className="sheet-header">
        ...
        <button aria-label="닫기" onClick={onClose} className="close">
          {/* ✕ */}×
        </button>
      </div>
      <div className="sheet-body">
        <section>
          <p className="sub-tit">거래유형</p>
